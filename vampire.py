...
TELEGRAM_BOT_TOKEN = '7995447638:AAGZIdxf4LFj5OIG-pgusWagXH4tlf3_GUw'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
       "*🚀ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ıllıllı ƔαɱקIııƦǝ ɱσ∂ χ DɗoS̴ S̴ǝƦƔǝƦ ıllıllı 🚀*\n\n"
        ...
        "*💀ꜱᴇʀᴠᴇʀ ꜰʀᴇᴇᴢ ᴡɪᴛʜ @Shailesh2346 🚀*" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @Shailesh2346💥*"
    ), parse_mode='Markdown')
